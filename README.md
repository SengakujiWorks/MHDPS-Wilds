...
**[Download MHDPS 0.1.4](https://github.com/SengakujiWorks/MHDPS-Wilds/releases/download/v0.1.4/MHDPS-Wilds-0.1.4.zip)** ·
...
- Automatic startup with the game, including your chosen dashboard.
...
1. Download **MHDPS-Wilds-0.1.4.zip** from [GitHub Releases](https://github.com/SengakujiWorks/MHDPS-Wilds/releases/latest).
...
or manual startup script is required. When updating, deactivate the previous
MHDPS version in Fluffy before replacing it through Vortex.

## First launch

Choose **Homepage** or **Local** when prompted. Your choice is saved and the
selected dashboard opens automatically on future game launches.

- **Homepage:** https://mhdps.sengakujiworks.com — includes spectator sharing.
- **Local:** http://localhost:8080 — for your own display.

If the public homepage asks for local-network access, allow it so the browser
can receive data from the companion running on your PC.
...
- [Startup helper](source/native/bootstrap.c)
- [Companion](source/relay/relay.py) · [Preferences and lifecycle](source/relay/startup.py)
